...
def parse_args():
    ...
    results.add_argument('--print-freq', default=100, type=int,
    ...
    exclusive_group(group=model, name='share-embedding', default=False,
    ...
    general.add_argument('--math', default='fp32', choices=['fp16', 'fp32', 'sketch_embed'],
    ...
    training.add_argument('--epochs', default=24, type=int,
    ...
    val.add_argument('--val-batch-size', default=8, type=int,
    ...
    test.add_argument('--test-batch-size', default=8, type=int,
    ...
    chkpt.add_argument('--save-all', action='store_true', default=True,
