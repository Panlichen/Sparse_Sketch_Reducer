...
class CifarTask:
    def __init__(self, device, timer, architecture, seed):
        ...
        #print(summary(self._model, torch.zeros((1, 3, 32, 32)), show_input=False, show_hierarchical=True))
    ...
    def _create_model(self):
        ...
        model = getattr(cifar_architectures, self._architecture)(num_classes = self.num_classes)
